...
import type { NavigationOption, User, UserOption } from "../types/Types"
import {classNames} from "../utils/Utils"


interface NavBarProps {
    navigationOps: NavigationOption[];
    userOps: UserOption[];
    user: User;
    logo: string;
}

const NavBar: React.FC<NavBarProps> = ({navigationOps, userOps, user, logo}) => {
    return(
        <>
